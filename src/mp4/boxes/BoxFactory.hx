...
import mp4.boxes.impl.*;
import mp4.boxes.impl.fd.*;
import mp4.boxes.impl.meta.*;
import mp4.boxes.impl.oma.*;
import mp4.boxes.impl.sampleentries.*;
import mp4.boxes.impl.sampleentries.codec.*;
import mp4.boxes.impl.ESDBox;
import mp4.boxes.impl.drm.FairPlayDataBox;

public class BoxFactory extends BoxTypes
{
	/*
	...
	*/
	//var Map<Long, Class<? extends BoxImpl>> BOX_CLASSES = new HashMap<Long, Class<? extends BoxImpl>>();
	var BOX_CLASSES : Map<Int, Class>;
	var Map<Long, Class<? extends BoxImpl>[]> BOX_MULTIPLE_CLASSES = new HashMap<Long, Class<? extends BoxImpl>[]>();
	var final Map<Long, String[]> PARAMETER = new HashMap<Long, String[]>();
