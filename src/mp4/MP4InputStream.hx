...
class MP4InputStream
{
	...
	static var MASK8 = 0xFF;
	static var MASK16 = 0xFFFF;
	static var UTF8 : String = "UTF-8";
	static var UTF16 : String = "UTF-16";
	static var BYTE_ORDER_MASK :Int = 0xFEFF;
	//var InputStream in_;
	...
	*/
	 ...
	 */
	public void read(b : BytesData, off : Int, len : Int)
	{
		var read = 0;
		var i = 0;
		...
		while (read < len)
		{
			if(in!=null) i = in_.read(b, off+read, len-read);
			read += i;
		}
	 ...
	 * stream has been closed, or if some other I/O error occurs.
	 */
	public function readBytes(b : BytesData)
	{
		read(b, 0, b.length);
	}
