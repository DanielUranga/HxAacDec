...
class HuffmanTables 
{	
	public static var HUFFMAN_OFFSET : Int = 64;
	public static var T_HUFFMAN_ENV_1_5DB : Array<Array<Int>> = [
		[1, 2], [-64, -65], [3, 4], [-63, -66],
		[5, 6], [-62, -67], [7, 8], [-61, -68],
	...
	public static var F_HUFFMAN_ENV_1_5DB  : Array<Array<Int>> = [
		[1, 2], [-64, -65], [3, 4], [-63, -66],
		[5, 6], [-67, -62], [7, 8], [-68, -61],
	...
	public static var T_HUFFMAN_ENV_BAL_1_5DB : Array<Array<Int>> = [
		[-64, 1], [-63, 2], [-65, 3], [-62, 4],
		[-66, 5], [-61, 6], [-67, 7], [-60, 8],
	...
	public static var F_HUFFMAN_ENV_BAL_1_5DB : Array<Array<Int>> = [
		[-64, 1], [-65, 2], [-63, 3], [-66, 4],
		[-62, 5], [-61, 6], [-67, 7], [-68, 8],
	...
	public static var T_HUFFMAN_ENV_3_0DB : Array<Array<Int>> = [
		[-64, 1], [-65, 2], [-63, 3], [-66, 4],
		[-62, 5], [-67, 6], [-61, 7], [-68, 8],
	...
	public static var F_HUFFMAN_ENV_3_0DB : Array<Array<Int>> = [
		[-64, 1], [-65, 2], [-63, 3], [-66, 4],
		[-62, 5], [-67, 6], [7, 8], [-61, -68],
		[9, 10], [-60, -69], [11, 12], [-59, -70],
		[13, 14], [-58, -71], [15, 16], [-57, -72],
	...
	public static var T_HUFFMAN_ENV_BAL_3_0DB : Array<Array<Int>> = [
		[-64, 1], [-63, 2], [-65, 3], [-66, 4],
		[-62, 5], [-61, 6], [-67, 7], [-68, 8],
	...
	public static var F_HUFFMAN_ENV_BAL_3_0DB : Array<Array<Int>> = [
		[-64, 1], [-65, 2], [-63, 3], [-66, 4],
		[-62, 5], [-61, 6], [-67, 7], [-68, 8],
	...
	public static var T_HUFFMAN_NOISE_3_0DB : Array<Array<Int>> = [
		[-64, 1], [-63, 2], [-65, 3], [-66, 4],
		[-62, 5], [-67, 6], [7, 8], [-61, -68],
	...
	public static var T_HUFFMAN_NOISE_BAL_3_0DB : Array<Array<Int>> = [
		[-64, 1], [-65, 2], [-63, 3], [4, 9],
		[-66, 5], [-62, 6], [7, 8], [-76, -75],
